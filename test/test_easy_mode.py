...
# In our case, we'll subclass the Vex2TestBase we defined in bases.py.
# class TestEasyModeLogic(Vex2TestBase):
...
#         # All other options in Vex2 are cosmetic, so we don't need to list them.
#     }
...
#                     "Final Boss Defeated", # Reminder: Vex2's victory condition uses this event location
#                 ],
#                 [["Sword"]],
#             )
...
# from .bases import Vex2TestBase
